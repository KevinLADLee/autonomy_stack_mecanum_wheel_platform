...
def generate_launch_description():
  ...
  declare_vehicleHeight = DeclareLaunchArgument('vehicleHeight', default_value='0.2', description='')
  ...
  # 图像压缩节点 - 将原始彩色图像转换为压缩图像
  start_color_image_compress = Node(
    package='image_transport',
    executable='republish',
    name='color_image_compress',
    arguments=['raw', 'compressed'],
    remappings=[
      ('in', '/D435/color/image_raw'),
      ('out/compressed', '/D435/color/image_raw/compressed'),
    ]
  )

  # 深度图像压缩节点 - 将原始深度图像转换为压缩图像
  # start_depth_image_compress = Node(
  #   package='image_transport',
  #   executable='republish',
  #   name='depth_image_compress',
  #   arguments=['raw', 'compressed'],
  #   remappings=[
  #     ('in', '/D435/depth/image_rect_raw'),
  #     ('out/compressed', '/D435/depth/image_rect_raw/compressed'),
  #   ]
  # )
  ...
  ld.add_action(start_color_image_compress)
  # ld.add_action(start_depth_image_compress)
